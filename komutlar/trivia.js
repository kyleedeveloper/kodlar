...
exports.run = (client, message, args) => {
    ...
    message.channel.sendFileFilesCodeEmbedMessage(Embed, {
        ...
        setTimeout(() => {
            ...
            const mesajyok = new discord.RichEmbed()
            .setAuthor("❌ Soru İptal Edildi!")
            .setDescription("**Soruyu Çözmek İçin Verilen 40 Saniye Doldu!**")
            .setColor("RED")
             message.channel.sendFileFilesCodeEmbedMessage(mesajyok).then(msg => {
                 setTimeout(() => {
